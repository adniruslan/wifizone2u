    ...
    <main class="main">
        ...
        <section id="contact" class="contact section">
            ...
            <div class="container section-title" data-aos="fade-up">
                <h2>Get 3 or 6 Months Free Internet

                </h2>
                <p>Special for <span style="color:#ffa500"> Unifi/CelcomDigi/Time</span> user who want to switch to Maxis</p>

                <div class="col-md-6 container section-title"><img src="assets/img/change2.png" alt="" class="img-fluid" id="order-form"></div>
            </div>
            <!-- End Section Title -->
                ...
                <div class="row gx-lg-0 gy-4">
                    ...
                    <section id="services" class="services section">
                        ...
                        <div class="container section-title" data-aos="fade-up">
                            ...
                            <p>
                                For new user, you can choose any of below package for Maxis Home plan.
                            </p>
                        </div>
                        <!-- End Section Title -->
                        ...
                        <div class="container">
                            <div class="row gy-4">
                                ...
                                <div class="col-md-8 service-item position-relative">
                                    <img src="assets/img/banner-maxis.jpg" alt="" class="img-fluid">
                                </div>
                                <div
                                    ...
                                    <div class="service-item position-relative">
                                        ...
                                        <h3>Maxis Home</h3>
                                        <p>
                                            Stay connected in every corner of your home with our wide range of internet plans. Explore now.
                                        </p>
